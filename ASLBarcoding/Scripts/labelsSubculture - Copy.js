...
function printLocally() {
    ...
    var RecordId = 0;
    if ($('#subcultureId').attr('value'))
        RecordId = $('#subcultureId').val();
                ...
                if (count > 0) {
                    ...
                    for (var i = 0; i < count; i++) {
                        if (labeltype == "Barcode25x13mm") {
                            ...
                            var k = (i + 1) * 1;
                            if (count > k) {
                                var vpfID2 = data[k].subcultureId;
                            ...
                            label.setObjectText("HDN", "CurrDt: " + data[i].currSubDate);
                            label.setObjectText("DLS", "LastDt: " + data[i].lastSubDate);
                        }
