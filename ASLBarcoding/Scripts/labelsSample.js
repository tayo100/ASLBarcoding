...
function printLocally() {
    ...
    //var SearchString = "";
    //var SearchCurrSubdate = "";
    //var SearchLastSubdate = "";

    //if ($('#SearchString').attr('value'))
    //    SearchString = $('#SearchString').val();

    //if ($('#SearchCurrSubdate').attr('value'))
    //    SearchCurrSubdate = $('#SearchCurrSubdate').val();

    //if ($('#SearchLastSubdate').attr('value'))
    //    SearchLastSubdate = $('#SearchLastSubdate').val();
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "/Samples/IndexDataList",
        // data: { searchString: SearchString, searchCurrSubdate: SearchCurrSubdate, searchLastSubdate: SearchLastSubdate, copies: copies, id: RecordId },
        data: { copies: copies, id: RecordId },
                ...
                if (count > 0) {
                    ...
                    for (var i = 0; i < count; i++) {
                        if (labeltype == "Barcode25x13mm") {
                            ...
                            label.setObjectText("TEXT", data[i].sampleType);                            
                            label.setObjectText("DLS", "SampleNo: " + data[i].sampleNo);
                            label.setObjectText("HDN", "WO#: " + data[i].workOrderNo);
                        }
