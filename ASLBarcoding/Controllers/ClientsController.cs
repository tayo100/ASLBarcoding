...
namespace ASLBarcoding.Controllers
{
    public class ClientController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address,BudgetNo,TelephoneNo,Email")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address,BudgetNo,TelephoneNo,Email")] Client client)
        {
            if (ModelState.IsValid)
            {
                var manager = new UserManager<ApplicationUser>(new Microsoft.AspNet.Identity.EntityFramework.UserStore<ApplicationUser>(new ApplicationDbContext()));
